...
"Parser:incompatible_read_kwargs" : "It appears as if some provided kwargs were incompatible with {func}!\nTry manually reading and parsing to avoid kwarg incompatibilities.",
